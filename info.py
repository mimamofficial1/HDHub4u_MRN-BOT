...
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/yhzga3.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/vapq9o.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/3ml4e3.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6139759254 7473323779').split()] # Replace with the actual admin ID(s) to add
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002136174732")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002745555397 -1002232443823 -1002761395296")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/x5j7is.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Mrn-Officialx@axl')    # Owner UPI ID for payments
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '2e6744a49a4fb7cc31accf2e067d78ea') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/MRN_Tutorial/1979")   # Tutorial link for 1st verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/MRN_Tutorial/1977")   # Tutorial link for 2nd verification

# Verification (Must Fill All Variables. Else You Got Error)
SHORTENER_API = environ.get("SHORTENER_API", "av_botz_DSHVK6nzn1jQU7kVL6FzcOqqvD4Vy") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "mrn-bypass-protect-bot-mrn-official.vercel.app") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "av_botz_hWbmF06W6Tzja560DOh13boecPLqD")  # Shortener API key for second website
