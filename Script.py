...
<b>ʀᴇǫ ʙʏ : {message.from_user.mention}</b>"""
    ...
    PREMIUM_TEXT = """<blockquote><b>🌟 𝐀𝐕𝐀𝐈𝐋𝐀𝐁𝐋𝐄 𝐏𝐋𝐀𝐍𝐒 🌟</b></blockquote>

<b>​🔐 𝐌𝐑𝐍 𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐀𝐂𝐂𝐄𝐒𝐒 🚀 
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖
❖ 𝐎𝐥𝐝 + 𝐋𝐚𝐭𝐞𝐬𝐭 𝐑𝐞𝐥𝐞𝐚𝐬𝐞𝐬 🔥
❖ 𝐀𝐥𝐥 𝐎𝐓𝐓 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 𝐂𝐨𝐧𝐭𝐞𝐧𝐭 🎭
❖ 𝐌𝐨𝐯𝐢𝐞𝐬 • 𝐖𝐞𝐛 𝐒𝐞𝐫𝐢𝐞𝐬 • 𝐓𝐕 𝐒𝐡𝐨𝐰𝐬 📺
❖ 𝐔𝐧𝐥𝐢𝐦𝐢𝐭𝐞𝐝 𝐂𝐨𝐧𝐭𝐞𝐧𝐭 𝐀𝐜𝐜𝐞𝐬𝐬 ♾️
❖ 𝐄𝐚𝐫𝐥𝐲 𝐀𝐜𝐜𝐞𝐬𝐬 𝐓𝐨 𝐋𝐚𝐭𝐞𝐬𝐭 𝐑𝐞𝐥𝐞𝐚𝐬𝐞𝐬 🚀
❖ 𝐀𝐥𝐥 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 ➜ 𝟐𝟒𝟎𝐩 • 𝟑𝟔𝟎𝐩 • 𝟒𝟖𝟎𝐩 • 𝟓𝟒𝟎𝐩 • 𝟕𝟐𝟎𝐩 • 𝟏𝟎𝟖𝟎𝐩 • 𝟒𝐊 💎
❖ 𝐔𝐥𝐭𝐫𝐚 𝐅𝐚𝐬𝐭 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 ⚡
❖ 𝐅𝐨𝐫𝐰𝐚𝐫𝐝 & 𝐒𝐡𝐚𝐫𝐞 𝐖𝐢𝐭𝐡𝐨𝐮𝐭 𝐋𝐢𝐦𝐢𝐭 📤
❖ 𝐃𝐢𝐫𝐞𝐜𝐭 𝐆𝐚𝐥𝐥𝐞𝐫𝐲 𝐒𝐚𝐯𝐞 📥
❖ 𝐌𝐨𝐯𝐢𝐞 / 𝐒𝐞𝐫𝐢𝐞𝐬 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐅𝐞𝐚𝐭𝐮𝐫𝐞 🎯
❖ 𝐍𝐨 𝐀𝐝𝐬 • 𝐍𝐨 𝐒𝐡𝐨𝐫𝐭𝐥𝐢𝐧𝐤𝐬 🚫
...
➤ 𝟏 𝐘𝐞𝐚𝐫      ➜ ₹𝟏𝟎𝟓𝟎. 👑
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖
🔓 𝐏𝐑𝐄𝐌𝐈𝐔𝐌 = 𝐅𝐔𝐋𝐋 𝐅𝐑𝐄𝐄𝐃𝐎𝐌

✔ 𝐅𝐨𝐫𝐰𝐚𝐫𝐝 𝐀𝐧𝐲𝐭𝐡𝐢𝐧𝐠
✔ 𝐒𝐡𝐚𝐫𝐞 𝐖𝐢𝐭𝐡𝐨𝐮𝐭 𝐑𝐞𝐬𝐭𝐫𝐢𝐜𝐭𝐢𝐨𝐧
✔ 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐃𝐢𝐫𝐞𝐜𝐭𝐥𝐲
✔ 𝐄𝐧𝐣𝐨𝐲 𝐀𝐝-𝐅𝐫𝐞𝐞 𝐄𝐱𝐩𝐞𝐫𝐢𝐞𝐧𝐜𝐞 ✨
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖
📨 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐍𝐎𝐖 ➜ @Mimam_Officialx
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - https://t.me/+lTO1v9u3v4FhODNl
...
‼️ ᴀꜰᴛᴇʀ ꜱᴇɴᴅɪɴɢ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ɢɪᴠᴇ ᴜꜱ ꜱᴏᴍᴇᴛɪᴍᴇꜱ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴘʀᴇᴍɪᴜᴍ ʟɪꜱᴛ.</b>"""  
    ...
    PREPLANS_TXT = PREMIUM_TEXT = """<blockquote><b>🌟 𝐀𝐕𝐀𝐈𝐋𝐀𝐁𝐋𝐄 𝐏𝐋𝐀𝐍𝐒 🌟</b></blockquote>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/mimam_ripper'>𝄟͢🦋⃟≛⃝ 𝐌𝐮𝐳𝐚𝐟𝐟𝐚𝐫 𝄟⃝❤</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
    ...
    # ✅ set_shortner_3, set_tutorial_3, set_time_2 removed
    SETTING_TXT = """    
<u>ꜱᴇᴛᴛɪɴɢꜱ</u> :
...
📌 ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ, ᴛᴀᴘ ᴏɴ ᴛʜᴇ ᴠᴇʀɪꜰʏ ʟɪɴᴋ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪɢɪᴄᴀᴛɪᴏɴ.
